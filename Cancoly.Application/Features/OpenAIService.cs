...
namespace Cancoly.Application.Features
{
    public class OpenAIService
    {
        ...
        public async Task<ScanOutputResource> GenerateOutput(string filePath)
        {
            try
            {
                ...
                var result = JsonSerializer.Deserialize<ScanOutputResource>(jsonResult, new JsonSerializerOptions
                {
